...
#I am sorry I could not do this because
#I do not know python and I did not have time to learn #it
import random #use random  numbers


def create_plane(rows,cols): #create a function
    """
